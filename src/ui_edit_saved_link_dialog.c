...
void ui_edit_saved_link_dialog_run(GtkWindow *parent, AppState *state,
    ...
    atk_object_set_name(gtk_widget_get_accessible(textview_widget), "Link");
    ...
    ui_bind_enter(textview_widget, dialog, GTK_RESPONSE_OK);
    ...
    GtkWidget *save_btn = ui_pill_button_new("Save");
